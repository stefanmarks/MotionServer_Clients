...
/// see the CircularReticle class.

public interface IGazePointer
{
	...
	void OnGazeStay(Camera camera, GameObject targetObject, Vector3 intersectionPosition, float fuseProgress, bool isInteractive);
